...
<T.PointLight position={[1, 3, 10]} intensity={4} decay={0.2} castShadow />
...
<T.Group>
    ...
    <BackendCube color={"#00D000"} position={backendPosition} />

    <FrontendCube color={"#F00000"} position={frontendPosition} />

    <ToolCube color={"#FA8000"} position={toolPosition} />

    <DatabaseCube color={"#0059FF"} position={databasePosition} />
</T.Group>
